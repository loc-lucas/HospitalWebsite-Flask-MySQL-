...
-- INSERT INTO BoardedPatient (NxtVisitTime, DepartID, NurseID, BoardedTime, ID)
-- VALUES
--     ('2021-01-12', 1, 341634578, '2020-11-23', 123456789),
--     ('2021-06-04', 3, 982367598, '2020-11-25', 091276243),
--     ('2021-08-23', 4, 670137514, '2020-11-24', 984316506),
--     ('2021-08-26', 1, 213415131, '2020-11-23', 830185245),
--     ('2021-10-12', 1, 670137514, '2020-11-26', 230761341),
--     ('2021-03-02', 2, 812749312, '2020-11-25', 527492357),
--     ('2021-03-22', 3, 571415109, '2020-11-24', 346282624)
-- ;

-- INSERT INTO Prescription (ExamID, DocID, Diet)
-- VALUES
--     (3, 461923053, 'None')
--     (6, 245015682, 'Eat fressh')
--     (1, 673582921, 'Eat healthy')
--     (8, 673582921, 'Meat only')
--     (7, 132468913, 'Chicken only')
--     (4, 812749801, 'Need more protein'
--     (2, 345615634, 'Drink 2 litres of water everyday')
--     (5, 461923053, 'Smoke is good')
-- ;

-- INSERT INTO Medicine (MedTime, Amount, UsageDes, MedName, PresID)
-- VALUES
--     (, 12, 'No usage found', "Apremumab", 1)
--     (, 2, '1 for a lifetime', "Ribamine Edrotroban", 2)
--     (, 26, '2 times a day - 3 pills each', 'Cefodiol', 3)
--     (, 50, '8 times a day', 'Aclorodine Tazocelex', 5)
--     (, 18, '2 times a day', 'Oflocriptine Viganitol', 1)
--     (, 6, '1 time a month', 'Paroridol',)
--     (, 45, '3 times a week every 2 days', 'Acecerol', 6)
--     (, 8, '1 times a day in the morning', 'Enavatol', 3)
--     (, 12, '2 times a week', 'Alkeprotin Chlorderm', 4)
-- ;

-- INSERT INTO BoardedRecord (PatientID, BoadedTime, BoardDis, LeavedAsnDocID, AsnDocID, BoardedCond, BedNo, LeaveTime, LeaveDis, LeaveNote, LeaveCond)
-- VALUES
    
-- ;

-- INSERT INTO Test (Result, CommonIndex)
-- VALUES
--     (12, 45)
--     (35, 50)
--     (60, [45, 90])
...
-- VALUES
--     (768056761, '0120201123A', 2), --1
--     (345615634, '0420201123A', 3), --3
--     (356474245, '0220201123B', 5), --4
--     (461923053, '0120201123A', 1), --1
--     (982367598, '0220201125A', 7), --7
--     (982367598, '0220201123B', 4), --4
--     (982367598, '0220201124B', 6), --6
--     (812749801, '0220201125A', 8), --7
--     (245015682, '0120201126A', 9)  --8
-- ;--done

-- INSERT INTO PerformFtest (DocID, ShiftID, FTestID)
-- VALUES
--     (673582921, '0120201123A', 1) --1
--     (812749801, '0120201123A', 2) --1
--     (812749801, '0220201123B', 4) --4
--     (768056761, '0220201125A', 6) --7
--     (132468913, '0120201126A', 7) --8
--     (673582921, '0320201126B', 8) --10
--     (673582921, '0420201123A', 3) --3
--     (345615634, '0220201123B', 5) --4
-- ;
...
--     (321456789, 213415131, 356474245, '0120201123A', 'Normal'),
--     --2
--     (830185245, 123241512, 245015682, '0220201123A', 'No brain found'),
--     --3
--     (230761341, 215134751, 812749801, '0420201123A', 'Heartbroken'),
--     --4
--     (234129568, 215134751, 132468913, '0220201123B', 'Abnormal'),
...
--     (335124161, 341634578, 812749801, '0420201124A', 'Crazy in love'),
--     --6
--     (245123468, 123241512, 673582921, '0220201124B', 'Broken Neck'),
--     --7
--     (091276243, 571415109, 245015682, '0220201125A', 'Malfunction Kidney'),  
--     --8
--     (984316506, 670137514, 356474245, '0120201126A', 'Multiple broken legs'),
--     --9
--     (123456789, 812749312, 345615634, '0320201126B', 'Broken Leg'),
--     --10
--     (527492357, 571415109, 982367598, '0320201126B', 'Unknown disease'),
